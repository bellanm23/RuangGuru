...
hoistedDependencies:
  ...
  /jest-cli/28.1.3:
    jest-cli: private
  /jest-config/28.1.3_@types+node@18.11.9:
    jest-config: private
  /jest-diff/29.3.1:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Mon, 12 Dec 2022 01:28:15 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
virtualStoreDir: C:\Users\Bella\Grader\assignments\RestApi\rest-api-exercise-1-v1\node_modules\.pnpm
